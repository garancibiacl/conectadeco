...
export default function HeroSection() {
  ...
  return (
    <section className="px-4 pt-8 pb-10 sm:px-6 lg:px-8 lg:pt-12">
      <div className="mx-auto max-w-7xl rounded-[2rem] bg-gradient-to-br from-rose-300 via-pink-300 to-fuchsia-300 p-5 shadow-[0_24px_60px_-35px_rgba(200,83,140,0.55)] sm:p-8 lg:p-10">
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-7 py-3 text-sm font-semibold text-rose-700 shadow-md shadow-rose-900/15 transition-all duration-300 hover:-translate-y-0.5 hover:bg-rose-50"
              >
                Ir a tienda <ArrowRight size={16} />
              </button>
              <button
                onClick={() => navigate('/registro')}
                className="rounded-full border border-white/65 bg-white/10 px-7 py-3 text-sm font-semibold text-white backdrop-blur-sm transition-colors hover:bg-white/20"
              >
                Personalizar
              </button>
            </div>
          ...
          <div className="mx-auto w-full max-w-[460px]">
            <div className="relative rounded-[1.75rem] bg-white/25 p-3 backdrop-blur-sm sm:p-4">
              <div className="overflow-hidden rounded-[1.4rem] bg-white p-4 shadow-[0_20px_30px_-20px_rgba(0,0,0,0.45)] sm:p-5">
                <img
                  ...
                  className="h-[280px] w-full rounded-2xl object-cover object-center sm:h-[340px]"
                />
              </div>
